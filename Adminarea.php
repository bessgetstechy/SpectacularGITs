...
<head>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="Homepage2.php">Home</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="AdminArea.php">Librarian's Area<span class="sr-only">(current)</a>
      </li>
    </ul>
...
<body>
    <br>
    <br>
        <h2 style="font-family: 'Pacifico', cursive;">Add Board Game</h2>
    <br>
    <br>
